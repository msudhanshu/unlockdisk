...
public class ConeSurfaceView extends CommonGLSurfaceView {

    public ConeSurfaceView(Context context) {
    	super(context);
        // Create an OpenGL ES 2.0 context.
        setEGLContextClientVersion(2);

        // Set the Renderer for drawing on the GLSurfaceView
        mRenderer = new ConeRenderer();
            ...
            case MotionEvent.ACTION_UP:
             ...
             //  mRenderer.mAngleX += dx* TOUCH_SCALE_FACTOR;  // = 180.0f / 320
               //  mRenderer.mAngleY += dy* TOUCH_SCALE_FACTOR;  // = 180.0f / 320
                ...
                mRenderer.imoveRing = -1;
        	    mRenderer.imoveSlice = -1;
                requestRender();
                dx = 0;
                dy = 0;
        }
