...
package com.unlockdisk.android.cone;
...
import com.unlockdisk.android.geometry.Cone;
...
public class ConeRenderer extends CommonGLRenderer {
	
	protected float height = 2.f;
	   public void onSurfaceCreated(GL10 unused, EGLConfig config) {
		   //mGeometry = new Sphere(radius,SPHERELONG_SEGMENT,SPHERELAT_SEGMENT);
		   mGeometry = new Cone(radius,height,SPHERELONG_SEGMENT,SPHERELAT_SEGMENT);
