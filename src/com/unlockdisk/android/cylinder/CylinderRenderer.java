...
package com.unlockdisk.android.cylinder;
...
import com.unlockdisk.android.geometry.Cylinder;
...
public class CylinderRenderer extends CommonGLRenderer {
	
	protected float height = 2.f;
	   public void onSurfaceCreated(GL10 unused, EGLConfig config) {
		   //mGeometry = new Sphere(radius,SPHERELONG_SEGMENT,SPHERELAT_SEGMENT);
		   mGeometry = new Cylinder(radius,height,SPHERELONG_SEGMENT,SPHERELAT_SEGMENT);
